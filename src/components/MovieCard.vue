...
>
   <div v-if="showOverviewFlag" @click.stop class="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-10">
...
>
   ...
   <div v-if="showTrailerFlag" @click.stop class="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-10">
...
function handleCardClick(event) {
 // Check if the click is not from a popup or a specific part of the card
...
.movie-card {
 position: relative; /* Set position to relative for the shine effect */
 overflow: visible; /* Allow the shine effect to show */
